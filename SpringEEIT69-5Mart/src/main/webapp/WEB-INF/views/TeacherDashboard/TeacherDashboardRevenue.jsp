	...
	<div class="bg-primary d-flex flex-row">
		<div class="d-flex flex-column p-3 bg-light" style="width: 300px;">
			...
			<ul class="nav nav-pills flex-column mb-auto">
				...
				<li><a href="<c:url value="/TeacherDashboard"></c:url>" class="nav-link active"> <span
...
<!-- 		選單右邊 -->
		<div class="d-flex flex-column p-3 bg-light" style="width: 300px;">
			<ul class="nav nav-pills flex-column mb-auto">
				<li class="nav-item"><a href="<c:url value="/TeacherDashboardRevenue"></c:url>" class="nav-link active"
