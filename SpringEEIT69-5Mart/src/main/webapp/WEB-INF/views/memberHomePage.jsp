...
<body>
	<!-- 導覽列 -->
	<jsp:include page="/WEB-INF/views/memberNavBar.jsp" />
	<!-- 導覽列 -->
	...
	<div class="container mb-5" style="position: relative;">
		...
		<div class="row slick-card-hotcourse">
			<div class="card mx-3 border-light">
				<a href="<c:url value='/courseDetail' />" class="nav-link"> <!-- 			連結延伸 class="stretched-link" -->
					<!--  <a href="<c:url value='/test2' />" class="nav-link">--> <img
					src="\SpringEEIT69-5Mart\assets\images\課程封面圖001.jpeg"
