							...
							<div class="card myCourseCard ">
								...
								<div class="card-body myCourseCardBody p-2 pe-0 w-100">
									...
									<div class="cta-section w-100 d-flex justify-content-center align-items-center ps-3">
										<a href="#" class="btn btn-light px-2"><i class="fa-solid fa-cart-shopping fa-xl"></i></a>
									</div>
								</div>
							</div>
						</li>
...
<!-- 																		</figure> figure-img img-fluid rounded -->
									<div class="card-body myCourseCardBody p-2 pe-0 w-100">
										...
										<div class="cta-section w-100 d-flex justify-content-center align-items-center ps-3">
											<a href="#" class="btn btn-light px-2"><i class="fa-solid fa-trash fa-xl"></i></a>
										</div>
									</div>
								</div>
							</li>
			...
			<div class="btn-group d-block headImg pe-2">
				<a class="nav-link dropdown-toggle " href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <!--  <img class="circleImg" src="\SpringEEIT69-5Mart\assets\images\人像頭貼001.jpg" /> --> <!-- 					<img class="circleImg" --> <%-- 					src="<c:if test="${not empty base64Image}"> --%> <%-- 					data:image/jpeg;base64,${base64Image} --%> <%-- 					</c:if>" /> --%> <img class="circleImg" src="<c:choose>
				...
				<ul class="dropdown-menu dropdown-menu-end px-1 fs-6">
					...
					<li><hr class="dropdown-divider"></li>
					<li class=""><a class="dropdown-item" href="#"><i class="fa-regular fa-user " style="padding: 0 8px"></i>個人檔案</a></li>
					<li><a class="dropdown-item" href="#"><i class="fa-solid fa-chalkboard" style="padding: 0 6px"></i>我的學習</a></li>
					<li><a class="dropdown-item" href="#"><i class="fa-regular fa-heart " style="padding: 0 7px"></i>願望清單</a></li>
					<li><a class="dropdown-item" href="#"><i class="bi bi-cart3" style="padding: 0 7px"></i>購物車</a></li>
					<li><hr class="dropdown-divider"></li>
					<li><a class="dropdown-item" href="#"><i class="fa-regular fa-file" style="padding: 0 9px"></i>訂單紀錄</a></li>
					...
					<li><hr class="dropdown-divider"></li>
					<li><a class="dropdown-item" href="<c:url value='/logout' />"><i class="fa-solid fa-arrow-right-from-bracket" style="padding: 0 7px"></i>登出</a></li>
				</ul>
			</div>
