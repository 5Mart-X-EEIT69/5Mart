...
<body>
	...
	<div class="container mb-5" style="position: relative;">
		...
		<div class="arrow-next slick-rightbtn">
			<span> <i class="fa-solid fa-chevron-right"></i>
			</span>
		</div>
		<div class="arrow-prev slick-leftbtn" >
	...
	<div class="container mb-5" style="position: relative;">
		...
		<div class="arrow-next1 slick-rightbtn">
			<span> <i class="fa-solid fa-chevron-right"></i>
			</span>
		</div>
		<div class="arrow-prev1 slick-leftbtn">
			<span> <i class="fa-solid fa-chevron-left"></i>
			</span>
		</div>
	</div>
